...
<title>Apoyos Escalera — README</title>
<style>
  :root {
    --bg: #0d1117;
    --bg2: #161b22;
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .badge.green { border-color: #00e676; color: #00e676; }
  .badge.blue  { border-color: #2979ff; color: #2979ff; }
  .badge.yellow{ border-color: #f5c400; color: #f5c400; }
  .badge.orange{ border-color: #ff6d00; color: #ff6d00; }
  .hero .link {
  ...
  .hero .link:hover { background: rgba(41,121,255,.12); }
  ...
  .fcard ul { list-style: none; padding: 0; }
  .fcard ul li {
  ...
  .specs-header .sub { color: var(--muted); font-size: 13px; margin-bottom: 18px; }
  ...
  .spec-table th {
    background: var(--bg3); font-weight: 700; font-size: 12px;
  ...
  .spec-h3 {
    font-size: .95rem; font-weight: 600; color: #cdd9e5;
    margin: 22px 0 10px;
  }

  /* permission table checkmarks */
  ...
  .role-grid {
    ...
    overflow: hidden; font-size: 13px; margin: 12px 0 20px;
  }
  .role-grid .rh {
  ...
  .role-grid .rc.left { justify-content: flex-start; color: var(--text); }
  .role-grid .rc:nth-child(10n+1),
  .role-grid .rc:nth-child(10n+6) { justify-content: flex-start; }
  .role-grid div:nth-child(n+6):nth-child(-n+10) { background: rgba(255,255,255,.015); }
  ...
  .checklist .prueba { flex: 1; color: var(--muted); }
  .checklist .expected { color: var(--text); flex: 1.2; }
  ...
  ul.spec-ul li {
    padding: 3px 0 3px 18px; position: relative; color: var(--muted); font-size: 13px;
  }
  ...
  .docs-callout p { color: var(--muted); font-size: 13px; margin: 0; }
...
<div class="hero">
  ...
  <a class="link" href="https://apoyosweb.netlify.app/" target="_blank">🌐 Ver demo en vivo</a>
</div>
